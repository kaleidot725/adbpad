...
object EnglishResources : StringResources {
    ...
    override val tooltipTimeEdit: String = "Time edit"
    ...
    override val timeEditEmpty: String = "No time settings yet."
    override val timeEditNoSelection: String = "Select or create a time setting."
    override val timeEditOverview: String = "Set a timezone and time for each item from the left menu."
    override val timeEditConfiguredTime: String = "Configured time"
    override val timeEditCurrentTime: String = "Current time"
    override val timeEditTitleLabel: String = "Title"
    override val timeEditTimeZoneLabel: String = "Time zone"
    override val timeEditHourLabel: String = "Hour"
    override val timeEditMinuteLabel: String = "Minute"
    override val timeEditDefaultTitle: String = "New time setting"
    override val timeEditInvalidTitle: String = "Title is required."
    override val timeEditInvalidTimeZone: String = "Select a valid IANA time zone."
    override val timeEditInvalidHour: String = "Hour must be between 0 and 23."
    override val timeEditInvalidMinute: String = "Minute must be between 0 and 59."
    override val timeEditDateTimeSection: String = "Date & Time"
    override val timeEditTimeZoneSection: String = "Time Zone"
    override val timeEditDateLabel: String = "Date"
    override val timeEditTimeLabel: String = "Time"
    override val timeEditTimeDifference: String = "Time difference"
    override val timeEditAutoDateTimeLabel: String = "Automatic date & time"
    override val timeEditAutoTimeZoneLabel: String = "Automatic time zone"
    override val timeEditInvalidDate: String = "Enter a date in yyyy-MM-dd."
    override val timeEditInvalidTime: String = "Enter a time in HH:mm or HH:mm:ss."
