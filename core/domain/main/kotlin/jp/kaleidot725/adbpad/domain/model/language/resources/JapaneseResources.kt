...
object JapaneseResources : StringResources {
    ...
    override val tooltipTimeEdit: String = "時刻編集"
    ...
    override val timeEditEmpty: String = "時刻設定がまだありません。"
    override val timeEditNoSelection: String = "時刻設定を選択するか、新しく作成してください。"
    override val timeEditOverview: String = "左の設定アイテムごとにタイムゾーンと時刻を編集できます。"
    override val timeEditConfiguredTime: String = "設定時刻"
    override val timeEditCurrentTime: String = "現在時刻"
    override val timeEditTitleLabel: String = "タイトル"
    override val timeEditTimeZoneLabel: String = "タイムゾーン"
    override val timeEditHourLabel: String = "時"
    override val timeEditMinuteLabel: String = "分"
    override val timeEditDefaultTitle: String = "新しい時刻設定"
    override val timeEditInvalidTitle: String = "タイトルを入力してください。"
    override val timeEditInvalidTimeZone: String = "有効なIANAタイムゾーンを選択してください。"
    override val timeEditInvalidHour: String = "時は0から23で入力してください。"
    override val timeEditInvalidMinute: String = "分は0から59で入力してください。"
    override val timeEditDateTimeSection: String = "日付時刻"
    override val timeEditTimeZoneSection: String = "タイムゾーン"
    override val timeEditDateLabel: String = "日付"
    override val timeEditTimeLabel: String = "時刻"
    override val timeEditTimeDifference: String = "時間差分"
    override val timeEditAutoDateTimeLabel: String = "日付時刻を自動同期"
    override val timeEditAutoTimeZoneLabel: String = "タイムゾーンを自動設定"
    override val timeEditInvalidDate: String = "日付は yyyy-MM-dd 形式で入力してください。"
    override val timeEditInvalidTime: String = "時刻は HH:mm または HH:mm:ss 形式で入力してください。"
