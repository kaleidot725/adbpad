...
object ChineseResources : StringResources {
    ...
    override val tooltipTimeEdit: String = "时间编辑"
    ...
    override val timeEditEmpty: String = "还没有时间设置。"
    override val timeEditNoSelection: String = "请选择或创建一个时间设置。"
    override val timeEditOverview: String = "可以为左侧的每个项目设置时区和时间。"
    override val timeEditConfiguredTime: String = "设定时间"
    override val timeEditCurrentTime: String = "当前时间"
    override val timeEditTitleLabel: String = "标题"
    override val timeEditTimeZoneLabel: String = "时区"
    override val timeEditHourLabel: String = "小时"
    override val timeEditMinuteLabel: String = "分钟"
    override val timeEditDefaultTitle: String = "新的时间设置"
    override val timeEditInvalidTitle: String = "标题为必填项。"
    override val timeEditInvalidTimeZone: String = "请选择有效的 IANA 时区。"
    override val timeEditInvalidHour: String = "小时必须在 0 到 23 之间。"
    override val timeEditInvalidMinute: String = "分钟必须在 0 到 59 之间。"
    override val timeEditDateTimeSection: String = "日期时间"
    override val timeEditTimeZoneSection: String = "时区"
    override val timeEditDateLabel: String = "日期"
    override val timeEditTimeLabel: String = "时间"
    override val timeEditTimeDifference: String = "时间差"
    override val timeEditAutoDateTimeLabel: String = "自动同步日期时间"
    override val timeEditAutoTimeZoneLabel: String = "自动设置时区"
    override val timeEditInvalidDate: String = "请输入 yyyy-MM-dd 格式的日期。"
    override val timeEditInvalidTime: String = "请输入 HH:mm 或 HH:mm:ss 格式的时间。"
